...
PHP_INI_BEGIN()
	...
	STD_PHP_INI_BOOLEAN("yaf.vbox_autoload", 	"1", PHP_INI_ALL, OnUpdateBool, vbox_autoload, zend_yaf_globals, yaf_globals)
	STD_PHP_INI_BOOLEAN("yaf.vbox_mvc", 		"1", PHP_INI_ALL, OnUpdateBool, vbox_mvc, zend_yaf_globals, yaf_globals)
